...
class BasicRecipeUpdateTest(APITestCase):
    ...
    def setUp(self):
        ...
        self.update_data = {
            ...
            "recipe_ingredients": [
                ...
                {"type": "meat", "name": "pancetta", "count": 100, "unit": "grams", "etc": "diced"},
                {"type": "dairy", "name": "Parmesan cheese", "count": 50, "unit": "grams", "etc": "grated"},
                {"type": "dairy", "name": "eggs", "count": 2, "unit": "units", "etc": "large eggs"},
                {"type": "spice", "name": "black pepper", "count": 1, "unit": "teaspoon", "etc": "freshly ground"},
            ],
            "recipe_image": [{"image_url": test_update_image1}, {"image_url": test_update_image2}],
            "recipe_process": [
    ...
    def test_update_basic_recipe_success(self):
        update_url = reverse("recipes:basic-recipes-update", kwargs={"id": self.recipe_id})
